...
\usepackage{dsfont}
\usepackage{geometry} % \usepackage[left=2cm,right=2cm, top=2cm,bottom=2cm,bindingoffset=0cm]{geometry} % Page geometry
\usepackage[utf8]{inputenc} % \usepackage[utf8x]{inputenc} % Encoding
\usepackage[T2A]{fontenc} % \usepackage[T1,T2A]{fontenc} % Font
...
% \fancyhead[LO,RE]{Example header left}
% \fancyhead[LE,RO]{Example header right}
% \fancyfoot[LO,RE]{Example footer left}
% \fancyfoot[LE,RO]{Example footer right}
